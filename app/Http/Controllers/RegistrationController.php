...
class RegistrationController extends Controller
{
    ...
    const PROEFLICENTIES = [
      ...
      'proeflicentie-natuurkunde-havo' => 'proeflicentie natuurkunde havo',
      'proeflicentie-scheikunde-havo' => 'proeflicentie scheikunde havo',
      'proeflicentie-wiskunde-a-havo' => 'proeflicentie wiskunde A havo',
      'proeflicentie-wiskunde-b-havo' => 'proeflicentie wiskunde B havo',
      'proeflicentie-natuurkunde-vwo' => 'proeflicentie natuurkunde vwo',
      'proeflicentie-scheikunde-vwo' => 'proeflicentie scheikunde vwo',
      'proeflicentie-wiskunde-a-vwo' => 'proeflicentie wiskunde A vwo',
      'proeflicentie-wiskunde-b-vwo' => 'proeflicentie wiskunde B vwo',
    ...
    const STREAMS = [
      'proeflicentie' => [ 1, 2 ],
      'proeflicentie-natuurkunde-havo' => [ 5 ],
      'proeflicentie-scheikunde-havo' => [ 8 ],
      'proeflicentie-wiskunde-a-havo' => [ 1 ],
      'proeflicentie-wiskunde-b-havo' => [ 3 ],
      'proeflicentie-natuurkunde-vwo' => [ 6 ],
      'proeflicentie-scheikunde-vwo' => [ 9 ],
      'proeflicentie-wiskunde-a-vwo' => [ 2 ],
      'proeflicentie-wiskunde-b-vwo' => [  4 ],
