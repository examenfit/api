...
use App\Imports\ChapterImport as ImportsChapterImport;

class ChapterImport extends Command
{
    private $question;
    private $topic;
    private $exam;
     ...
     * @var string
     */
    protected $signature = 'ef:import:chapters {file}';
    ...
    {
        $collection = Excel::toCollection(new ImportsChapterImport, $file);
    ...
    private function processRow($row)
    {
        ...
        $this->processChapter($row['hoofdstuk'], $row['titel']);
    }
    ...
    private function processChapter($name, $title)
    {
        if (!$name) {
            return;
        }
